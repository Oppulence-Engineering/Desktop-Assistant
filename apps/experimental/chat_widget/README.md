...
1. Reads/creates a guest session against the Oppulence API (`/api/widget/v1/session/guest`).
...
| `ROWBOAT_HOST`     | yes      | Public origin of the Oppulence API — used as `${ROWBOAT_HOST}/api/widget/v1` |
