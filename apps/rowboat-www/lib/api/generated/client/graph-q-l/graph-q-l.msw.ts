...
import type { GraphQLResponse } from "../model";

import { getGraphqlResponseMock } from "./graph-q-l.faker";

export { getGraphqlResponseMock } from "./graph-q-l.faker";

export const getGraphqlMockHandler = (
  overrideResponse?:
    | GraphQLResponse
    | ((
...
export const getGraphQLMock = () => [getGraphqlMockHandler()];
