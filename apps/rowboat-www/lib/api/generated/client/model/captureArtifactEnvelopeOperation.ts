 ...
 */
export type CaptureArtifactEnvelopeOperation =
  (typeof CaptureArtifactEnvelopeOperation)[keyof typeof CaptureArtifactEnvelopeOperation];

export const CaptureArtifactEnvelopeOperation = {
  upsert: "upsert",
  delete: "delete",
} as const;
