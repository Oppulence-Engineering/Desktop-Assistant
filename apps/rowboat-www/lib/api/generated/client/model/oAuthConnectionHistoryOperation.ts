 ...
 */
export type OAuthConnectionHistoryOperation =
  (typeof OAuthConnectionHistoryOperation)[keyof typeof OAuthConnectionHistoryOperation];

export const OAuthConnectionHistoryOperation = {
  INSERT: "INSERT",
  UPDATE: "UPDATE",
  DELETE: "DELETE",
} as const;
