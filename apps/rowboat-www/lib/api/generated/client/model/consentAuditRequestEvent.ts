 ...
 */
export type ConsentAuditRequestEvent =
  (typeof ConsentAuditRequestEvent)[keyof typeof ConsentAuditRequestEvent];

export const ConsentAuditRequestEvent = {
  consentshown: "consent.shown",
