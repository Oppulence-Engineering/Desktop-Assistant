 ...
 */
export type CreateCommitmentDependencyBodyKind =
  (typeof CreateCommitmentDependencyBodyKind)[keyof typeof CreateCommitmentDependencyBodyKind];

export const CreateCommitmentDependencyBodyKind = {
  blocks: "blocks",
  requires: "requires",
