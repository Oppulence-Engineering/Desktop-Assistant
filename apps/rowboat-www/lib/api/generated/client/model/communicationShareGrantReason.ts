 ...
 */
export type CommunicationShareGrantReason =
  (typeof CommunicationShareGrantReason)[keyof typeof CommunicationShareGrantReason];

export const CommunicationShareGrantReason = {
  llm_call: "llm_call",
