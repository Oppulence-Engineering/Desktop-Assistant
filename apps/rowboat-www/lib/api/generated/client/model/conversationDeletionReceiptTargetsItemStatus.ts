 ...
 * Target state.
 */
export type ConversationDeletionReceiptTargetsItemStatus =
  (typeof ConversationDeletionReceiptTargetsItemStatus)[keyof typeof ConversationDeletionReceiptTargetsItemStatus];

export const ConversationDeletionReceiptTargetsItemStatus = {
  pending: "pending",
  deleted: "deleted",
  not_found: "not_found",
  blocked: "blocked",
