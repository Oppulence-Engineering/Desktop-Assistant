 ...
 */
import type { HubSpotSearchObject } from "./hubSpotSearchObject";
import type { HubSpotSearchResponseObjectType } from "./hubSpotSearchResponseObjectType";

/**
 * Native HubSpot SDK search result.
 */
export interface HubSpotSearchResponse {
  /** Canonical CRM object type. */
  objectType: HubSpotSearchResponseObjectType;
  /** Bounded matching records. */
  results: HubSpotSearchObject[];
  /** Total matching HubSpot records. */
  total: number;
}
