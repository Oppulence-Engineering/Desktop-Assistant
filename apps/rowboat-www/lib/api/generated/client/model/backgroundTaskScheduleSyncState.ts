 ...
 */
export type BackgroundTaskScheduleSyncState =
  (typeof BackgroundTaskScheduleSyncState)[keyof typeof BackgroundTaskScheduleSyncState];

export const BackgroundTaskScheduleSyncState = {
  current: "current",
  syncing: "syncing",
  failed: "failed",
  paused: "paused",
