 ...
 * Source provider.
 */
export type RelationshipSourceStatusSource =
  (typeof RelationshipSourceStatusSource)[keyof typeof RelationshipSourceStatusSource];

export const RelationshipSourceStatusSource = {
  google: "google",
  slack: "slack",
  hubspot: "hubspot",
} as const;
