 ...
 */
export type DurableAgentSessionViewStatus =
  (typeof DurableAgentSessionViewStatus)[keyof typeof DurableAgentSessionViewStatus];

export const DurableAgentSessionViewStatus = {
  active: "active",
  paused: "paused",
  completed: "completed",
  failed: "failed",
