 ...
 */
export type RelationshipAttentionItemStatus =
  (typeof RelationshipAttentionItemStatus)[keyof typeof RelationshipAttentionItemStatus];

export const RelationshipAttentionItemStatus = {
  open: "open",
