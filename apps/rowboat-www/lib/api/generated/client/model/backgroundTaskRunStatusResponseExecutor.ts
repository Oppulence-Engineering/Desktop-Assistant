 ...
 * Execution backend.
 */
export type BackgroundTaskRunStatusResponseExecutor =
  (typeof BackgroundTaskRunStatusResponseExecutor)[keyof typeof BackgroundTaskRunStatusResponseExecutor];

export const BackgroundTaskRunStatusResponseExecutor = {
  desktop: "desktop",
  api: "api",
} as const;
