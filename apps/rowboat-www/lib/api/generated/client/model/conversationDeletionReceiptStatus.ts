 ...
 */
export type ConversationDeletionReceiptStatus =
  (typeof ConversationDeletionReceiptStatus)[keyof typeof ConversationDeletionReceiptStatus];

export const ConversationDeletionReceiptStatus = {
  pending: "pending",
  blocked: "blocked",
  partial: "partial",
  verified: "verified",
