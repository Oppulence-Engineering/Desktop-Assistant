 ...
 * Response kind.
 */
export type RespondPublicMutualActionPlanBodyKind =
  (typeof RespondPublicMutualActionPlanBodyKind)[keyof typeof RespondPublicMutualActionPlanBodyKind];

export const RespondPublicMutualActionPlanBodyKind = {
  confirm: "confirm",
  correct: "correct",
  blocked: "blocked",
  completed: "completed",
