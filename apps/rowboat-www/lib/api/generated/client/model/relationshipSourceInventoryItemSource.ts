 ...
 * Source provider.
 */
export type RelationshipSourceInventoryItemSource =
  (typeof RelationshipSourceInventoryItemSource)[keyof typeof RelationshipSourceInventoryItemSource];

export const RelationshipSourceInventoryItemSource = {
  google: "google",
  slack: "slack",
  hubspot: "hubspot",
} as const;
