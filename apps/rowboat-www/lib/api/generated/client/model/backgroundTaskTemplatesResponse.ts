 ...
 */
import type { BackgroundTaskTemplate } from "./backgroundTaskTemplate";

/**
 * Built-in background task templates available to the authenticated user.
 */
export interface BackgroundTaskTemplatesResponse {
  /** Available task templates. */
  templates: BackgroundTaskTemplate[];
}
