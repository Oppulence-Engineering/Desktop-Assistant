 ...
 * Trigger source.
 */
export type BackgroundTaskRunPatchRequestTrigger =
  (typeof BackgroundTaskRunPatchRequestTrigger)[keyof typeof BackgroundTaskRunPatchRequestTrigger];

export const BackgroundTaskRunPatchRequestTrigger = {
  manual: "manual",
  cron: "cron",
  window: "window",
  event: "event",
