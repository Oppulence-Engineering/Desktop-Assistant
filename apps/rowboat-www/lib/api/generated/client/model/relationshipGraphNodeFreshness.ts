 ...
 * Evidence freshness.
 */
export type RelationshipGraphNodeFreshness =
  (typeof RelationshipGraphNodeFreshness)[keyof typeof RelationshipGraphNodeFreshness];

export const RelationshipGraphNodeFreshness = {
  current: "current",
  aging: "aging",
  stale: "stale",
  unknown: "unknown",
