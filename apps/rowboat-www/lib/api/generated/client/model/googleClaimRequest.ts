...
/**
 * Redeems a one-time Google OAuth handoff ticket parked by /oauth/google/callback.
 */
export interface GoogleClaimRequest {
  /** Opaque state/session ticket returned to the desktop deep link. */
  session: string;
}
