...
export type ListRelationshipIdentityCandidatesStatus =
  (typeof ListRelationshipIdentityCandidatesStatus)[keyof typeof ListRelationshipIdentityCandidatesStatus];

export const ListRelationshipIdentityCandidatesStatus = {
  pending: "pending",
  deferred: "deferred",
  resolving: "resolving",
  resolved: "resolved",
