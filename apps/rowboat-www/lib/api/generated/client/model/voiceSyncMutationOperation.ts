 ...
 */
export type VoiceSyncMutationOperation =
  (typeof VoiceSyncMutationOperation)[keyof typeof VoiceSyncMutationOperation];

export const VoiceSyncMutationOperation = {
  upsert: "upsert",
  delete: "delete",
} as const;
