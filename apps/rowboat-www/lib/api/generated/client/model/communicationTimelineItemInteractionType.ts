 ...
 * Interaction kind.
 */
export type CommunicationTimelineItemInteractionType =
  (typeof CommunicationTimelineItemInteractionType)[keyof typeof CommunicationTimelineItemInteractionType];

export const CommunicationTimelineItemInteractionType = {
  email: "email",
  meeting: "meeting",
} as const;
