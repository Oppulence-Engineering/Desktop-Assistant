 ...
 */
import type { DecideRelationshipIdentityCandidateBodyDecision } from "./decideRelationshipIdentityCandidateBodyDecision";

/**
 * Identity decision request.
 */
export type DecideRelationshipIdentityCandidateBody = {
  /** Decision. */
  decision: DecideRelationshipIdentityCandidateBodyDecision;
