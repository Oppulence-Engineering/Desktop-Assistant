 ...
 */
import type { BackgroundTaskRunEventInput } from "./backgroundTaskRunEventInput";

/**
 * Batch append for JSONL run events. Existing seq values are skipped to make retries idempotent.
 */
export interface BackgroundTaskRunEventsAppendRequest {
  /** Events to append. */
  events: BackgroundTaskRunEventInput[];
}
