 ...
 * Execution mode.
 */
export type CreateRevenueActionBodyExecutionMode =
  (typeof CreateRevenueActionBodyExecutionMode)[keyof typeof CreateRevenueActionBodyExecutionMode];

export const CreateRevenueActionBodyExecutionMode = {
  draft: "draft",
  send: "send",
} as const;
