 ...
 * Observed sentiment.
 */
export type RevenueRelationshipSentiment =
  (typeof RevenueRelationshipSentiment)[keyof typeof RevenueRelationshipSentiment];

export const RevenueRelationshipSentiment = {
  unknown: "unknown",
  positive: "positive",
  mixed: "mixed",
  negative: "negative",
