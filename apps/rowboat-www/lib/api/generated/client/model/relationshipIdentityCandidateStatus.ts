 ...
 */
export type RelationshipIdentityCandidateStatus =
  (typeof RelationshipIdentityCandidateStatus)[keyof typeof RelationshipIdentityCandidateStatus];

export const RelationshipIdentityCandidateStatus = {
  pending: "pending",
  deferred: "deferred",
  resolving: "resolving",
  resolved: "resolved",
