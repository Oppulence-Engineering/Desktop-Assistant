 ...
 */
export type AccountDeletionRequestConfirm =
  (typeof AccountDeletionRequestConfirm)[keyof typeof AccountDeletionRequestConfirm];

export const AccountDeletionRequestConfirm = {
  DELETE: "DELETE",
} as const;
