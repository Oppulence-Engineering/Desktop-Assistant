 ...
 */
export type ConsolePreferencesPatchNotificationLevel =
  (typeof ConsolePreferencesPatchNotificationLevel)[keyof typeof ConsolePreferencesPatchNotificationLevel];

export const ConsolePreferencesPatchNotificationLevel = {
  off: "off",
  attention: "attention",
  all: "all",
} as const;
