...
export type ListBackgroundTaskRunsStatus =
  (typeof ListBackgroundTaskRunsStatus)[keyof typeof ListBackgroundTaskRunsStatus];

export const ListBackgroundTaskRunsStatus = {
  queued: "queued",
  running: "running",
  succeeded: "succeeded",
  failed: "failed",
