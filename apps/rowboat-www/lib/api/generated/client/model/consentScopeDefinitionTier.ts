 ...
 * Risk tier.
 */
export type ConsentScopeDefinitionTier =
  (typeof ConsentScopeDefinitionTier)[keyof typeof ConsentScopeDefinitionTier];

export const ConsentScopeDefinitionTier = {
  low: "low",
  medium: "medium",
  high: "high",
