 ...
 */
export type ConsolePreferencesPatchTheme =
  (typeof ConsolePreferencesPatchTheme)[keyof typeof ConsolePreferencesPatchTheme];

export const ConsolePreferencesPatchTheme = {
  light: "light",
  dark: "dark",
  system: "system",
} as const;
