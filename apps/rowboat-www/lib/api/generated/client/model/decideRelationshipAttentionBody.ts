 ...
 */
import type { DecideRelationshipAttentionBodyDecision } from "./decideRelationshipAttentionBodyDecision";

/**
 * Attention decision request.
 */
export type DecideRelationshipAttentionBody = {
  /** Decision. */
  decision: DecideRelationshipAttentionBodyDecision;
  /** Expected version. */
  expectedVersion: number;
  /** Decision reason. */
  reason?: string;
  /**
   * Bounded future wake time.
   * @nullable
   */
