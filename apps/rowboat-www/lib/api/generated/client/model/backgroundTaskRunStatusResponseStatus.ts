 ...
 */
export type BackgroundTaskRunStatusResponseStatus =
  (typeof BackgroundTaskRunStatusResponseStatus)[keyof typeof BackgroundTaskRunStatusResponseStatus];

export const BackgroundTaskRunStatusResponseStatus = {
  queued: "queued",
  running: "running",
  succeeded: "succeeded",
  failed: "failed",
