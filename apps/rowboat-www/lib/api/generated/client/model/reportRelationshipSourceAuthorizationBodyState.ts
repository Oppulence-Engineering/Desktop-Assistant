 ...
 * Consent transition.
 */
export type ReportRelationshipSourceAuthorizationBodyState =
  (typeof ReportRelationshipSourceAuthorizationBodyState)[keyof typeof ReportRelationshipSourceAuthorizationBodyState];

export const ReportRelationshipSourceAuthorizationBodyState = {
  started: "started",
  completed: "completed",
  canceled: "canceled",
  failed: "failed",
