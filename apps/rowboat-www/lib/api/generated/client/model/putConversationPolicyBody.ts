 ...
 */
import type { PutConversationPolicyBodyLayersItem } from "./putConversationPolicyBodyLayersItem";

/**
 * Policy update.
 */
export type PutConversationPolicyBody = {
  /** Versioned policy layers. */
  layers: PutConversationPolicyBodyLayersItem[];
};
