 ...
 */
export type CaptureArtifactEnvelopeSchemaVersion =
  (typeof CaptureArtifactEnvelopeSchemaVersion)[keyof typeof CaptureArtifactEnvelopeSchemaVersion];

export const CaptureArtifactEnvelopeSchemaVersion = {
  "10": "1.0",
} as const;
