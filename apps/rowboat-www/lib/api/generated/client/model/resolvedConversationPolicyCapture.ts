 ...
 * Capture rule.
 */
export type ResolvedConversationPolicyCapture =
  (typeof ResolvedConversationPolicyCapture)[keyof typeof ResolvedConversationPolicyCapture];

export const ResolvedConversationPolicyCapture = {
  deny: "deny",
