 ...
 */
export type RevenueActionExecutionMode =
  (typeof RevenueActionExecutionMode)[keyof typeof RevenueActionExecutionMode];

export const RevenueActionExecutionMode = {
  draft: "draft",
  send: "send",
} as const;
