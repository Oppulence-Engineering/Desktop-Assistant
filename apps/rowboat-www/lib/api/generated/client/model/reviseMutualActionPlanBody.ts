 ...
 */
import type { ReviseMutualActionPlanBodyItemsItem } from "./reviseMutualActionPlanBodyItemsItem";

/**
 * Plan revision request.
 */
export type ReviseMutualActionPlanBody = {
  /** Plan items. */
  items: ReviseMutualActionPlanBodyItemsItem[];
};
