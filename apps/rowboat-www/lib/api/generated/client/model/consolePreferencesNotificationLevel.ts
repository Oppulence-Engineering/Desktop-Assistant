 ...
 */
export type ConsolePreferencesNotificationLevel =
  (typeof ConsolePreferencesNotificationLevel)[keyof typeof ConsolePreferencesNotificationLevel];

export const ConsolePreferencesNotificationLevel = {
  off: "off",
  attention: "attention",
  all: "all",
} as const;
