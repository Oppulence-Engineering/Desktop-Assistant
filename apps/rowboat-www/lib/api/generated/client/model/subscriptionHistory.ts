 ...
 */
import type { SubscriptionHistoryOperation } from "./subscriptionHistoryOperation";
import type { SubscriptionHistoryPlan } from "./subscriptionHistoryPlan";

/**
 * Audit history for Subscription rows.
 */
export interface SubscriptionHistory {
  ...
  operation: SubscriptionHistoryOperation;
  /** Billing plan slug. */
