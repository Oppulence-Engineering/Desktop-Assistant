...
export type ListRevenueActionsQueueStatus =
  (typeof ListRevenueActionsQueueStatus)[keyof typeof ListRevenueActionsQueueStatus];

export const ListRevenueActionsQueueStatus = {
  open: "open",
  snoozed: "snoozed",
  dismissed: "dismissed",
  handled: "handled",
