 ...
 */
import type { BetaDiagnosticsChecksItemStatus } from "./betaDiagnosticsChecksItemStatus";

/**
 * Diagnostic check.
 */
export type BetaDiagnosticsChecksItem = {
  /** Stable check code. */
  code: string;
  /** Affected objects. */
  count: number;
  /** Content-free operator explanation. */
  explanation: string;
  /** Check state. */
  status: BetaDiagnosticsChecksItemStatus;
};
