 ...
 */
export type BackgroundTaskRunPatchRequestStatus =
  (typeof BackgroundTaskRunPatchRequestStatus)[keyof typeof BackgroundTaskRunPatchRequestStatus];

export const BackgroundTaskRunPatchRequestStatus = {
  queued: "queued",
  running: "running",
  succeeded: "succeeded",
  failed: "failed",
