 ...
 * Delivery channel.
 */
export type CreateRevenueActionBodyChannel =
  (typeof CreateRevenueActionBodyChannel)[keyof typeof CreateRevenueActionBodyChannel];

export const CreateRevenueActionBodyChannel = {
  email: "email",
  slack: "slack",
  call: "call",
  crm_task: "crm_task",
