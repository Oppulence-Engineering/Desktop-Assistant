 ...
 * Event kind.
 */
export type AppendCommitmentTransitionBodyKind =
  (typeof AppendCommitmentTransitionBodyKind)[keyof typeof AppendCommitmentTransitionBodyKind];

export const AppendCommitmentTransitionBodyKind = {
