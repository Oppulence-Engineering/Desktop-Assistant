 ...
 */
export type RelationshipCommitmentStatus =
  (typeof RelationshipCommitmentStatus)[keyof typeof RelationshipCommitmentStatus];

export const RelationshipCommitmentStatus = {
  open: "open",
  fulfilled: "fulfilled",
  missed: "missed",
  waived: "waived",
