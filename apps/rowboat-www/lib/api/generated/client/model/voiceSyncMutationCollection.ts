 ...
 * Capture collection.
 */
export type VoiceSyncMutationCollection =
  (typeof VoiceSyncMutationCollection)[keyof typeof VoiceSyncMutationCollection];

export const VoiceSyncMutationCollection = {
  note: "note",
  folder: "folder",
