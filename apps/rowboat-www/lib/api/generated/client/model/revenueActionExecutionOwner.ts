 ...
 */
export type RevenueActionExecutionOwner =
  (typeof RevenueActionExecutionOwner)[keyof typeof RevenueActionExecutionOwner];

export const RevenueActionExecutionOwner = {
  rowboat: "rowboat",
  outbound: "outbound",
} as const;
