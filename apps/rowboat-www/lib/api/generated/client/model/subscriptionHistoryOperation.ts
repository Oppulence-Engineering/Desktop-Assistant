 ...
 */
export type SubscriptionHistoryOperation =
  (typeof SubscriptionHistoryOperation)[keyof typeof SubscriptionHistoryOperation];

export const SubscriptionHistoryOperation = {
  INSERT: "INSERT",
  UPDATE: "UPDATE",
  DELETE: "DELETE",
} as const;
