 ...
 */
export type AgentDefinitionHistoryOperation =
  (typeof AgentDefinitionHistoryOperation)[keyof typeof AgentDefinitionHistoryOperation];

export const AgentDefinitionHistoryOperation = {
  INSERT: "INSERT",
  UPDATE: "UPDATE",
  DELETE: "DELETE",
} as const;
