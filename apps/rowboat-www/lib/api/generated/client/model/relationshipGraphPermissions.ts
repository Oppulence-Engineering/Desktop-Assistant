 ...
 */
export type RelationshipGraphPermissions = {
  /** May approve current action revisions. */
  canApprove: boolean;
  /** May propose state or actions. */
  canContribute: boolean;
  /** May explicitly execute approved actions. */
  canExecute: boolean;
  /** May save graph views. */
