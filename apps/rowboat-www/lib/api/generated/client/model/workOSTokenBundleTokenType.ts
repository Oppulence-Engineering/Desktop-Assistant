 ...
 * Token type.
 */
export type WorkOSTokenBundleTokenType =
  (typeof WorkOSTokenBundleTokenType)[keyof typeof WorkOSTokenBundleTokenType];

export const WorkOSTokenBundleTokenType = {
  Bearer: "Bearer",
} as const;
