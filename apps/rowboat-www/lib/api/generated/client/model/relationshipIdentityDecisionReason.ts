 ...
 */
export type RelationshipIdentityDecisionReason =
  (typeof RelationshipIdentityDecisionReason)[keyof typeof RelationshipIdentityDecisionReason];

export const RelationshipIdentityDecisionReason = {
  llm_call: "llm_call",
