 ...
 * Graph scope.
 */
export type ConsoleGraphSavedViewStateScope =
  (typeof ConsoleGraphSavedViewStateScope)[keyof typeof ConsoleGraphSavedViewStateScope];

export const ConsoleGraphSavedViewStateScope = {
  portfolio: "portfolio",
