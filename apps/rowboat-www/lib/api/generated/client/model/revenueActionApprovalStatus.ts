 ...
 */
export type RevenueActionApprovalStatus =
  (typeof RevenueActionApprovalStatus)[keyof typeof RevenueActionApprovalStatus];

export const RevenueActionApprovalStatus = {
  pending: "pending",
  approved: "approved",
  rejected: "rejected",
} as const;
