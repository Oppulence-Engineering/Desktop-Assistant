 ...
 */
export type MCPConnectionHistoryOperation =
  (typeof MCPConnectionHistoryOperation)[keyof typeof MCPConnectionHistoryOperation];

export const MCPConnectionHistoryOperation = {
  INSERT: "INSERT",
  UPDATE: "UPDATE",
  DELETE: "DELETE",
} as const;
