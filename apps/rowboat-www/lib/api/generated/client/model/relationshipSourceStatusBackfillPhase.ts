 ...
 * Backfill phase.
 */
export type RelationshipSourceStatusBackfillPhase =
  (typeof RelationshipSourceStatusBackfillPhase)[keyof typeof RelationshipSourceStatusBackfillPhase];

export const RelationshipSourceStatusBackfillPhase = {
  idle: "idle",
  queued: "queued",
  running: "running",
  live: "live",
