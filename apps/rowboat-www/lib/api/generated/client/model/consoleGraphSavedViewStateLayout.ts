 ...
 * Graph layout.
 */
export type ConsoleGraphSavedViewStateLayout =
  (typeof ConsoleGraphSavedViewStateLayout)[keyof typeof ConsoleGraphSavedViewStateLayout];

export const ConsoleGraphSavedViewStateLayout = {
  force: "force",
  radial: "radial",
  timeline: "timeline",
} as const;
