 ...
 * Envelope version.
 */
export type VoiceSyncMutationSchemaVersion =
  (typeof VoiceSyncMutationSchemaVersion)[keyof typeof VoiceSyncMutationSchemaVersion];

export const VoiceSyncMutationSchemaVersion = {
  "10": "1.0",
} as const;
