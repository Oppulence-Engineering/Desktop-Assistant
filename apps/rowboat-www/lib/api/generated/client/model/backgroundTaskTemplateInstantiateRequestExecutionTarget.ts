 ...
 */
export type BackgroundTaskTemplateInstantiateRequestExecutionTarget =
  (typeof BackgroundTaskTemplateInstantiateRequestExecutionTarget)[keyof typeof BackgroundTaskTemplateInstantiateRequestExecutionTarget];

export const BackgroundTaskTemplateInstantiateRequestExecutionTarget = {
  desktop: "desktop",
  api: "api",
} as const;
