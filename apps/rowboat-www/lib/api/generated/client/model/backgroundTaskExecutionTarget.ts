 ...
 */
export type BackgroundTaskExecutionTarget =
  (typeof BackgroundTaskExecutionTarget)[keyof typeof BackgroundTaskExecutionTarget];

export const BackgroundTaskExecutionTarget = {
  desktop: "desktop",
  api: "api",
} as const;
