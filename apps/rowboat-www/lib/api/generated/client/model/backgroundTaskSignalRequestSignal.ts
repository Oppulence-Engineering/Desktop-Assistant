 ...
 */
export type BackgroundTaskSignalRequestSignal =
  (typeof BackgroundTaskSignalRequestSignal)[keyof typeof BackgroundTaskSignalRequestSignal];

export const BackgroundTaskSignalRequestSignal = {
  pause: "pause",
  resume: "resume",
