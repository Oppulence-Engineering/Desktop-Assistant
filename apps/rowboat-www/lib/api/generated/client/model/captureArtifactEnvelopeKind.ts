 ...
 * Artifact kind.
 */
export type CaptureArtifactEnvelopeKind =
  (typeof CaptureArtifactEnvelopeKind)[keyof typeof CaptureArtifactEnvelopeKind];

export const CaptureArtifactEnvelopeKind = {
  note: "note",
