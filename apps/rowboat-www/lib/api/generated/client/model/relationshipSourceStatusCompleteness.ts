 ...
 */
export type RelationshipSourceStatusCompleteness =
  (typeof RelationshipSourceStatusCompleteness)[keyof typeof RelationshipSourceStatusCompleteness];

export const RelationshipSourceStatusCompleteness = {
  complete: "complete",
  partial: "partial",
  stale: "stale",
