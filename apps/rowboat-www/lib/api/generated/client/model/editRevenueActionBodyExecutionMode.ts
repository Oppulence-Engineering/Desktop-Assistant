 ...
 * Execution mode.
 */
export type EditRevenueActionBodyExecutionMode =
  (typeof EditRevenueActionBodyExecutionMode)[keyof typeof EditRevenueActionBodyExecutionMode];

export const EditRevenueActionBodyExecutionMode = {
  draft: "draft",
  send: "send",
} as const;
