 ...
 * Acceptance state.
 */
export type RelationshipCommitmentAcceptance =
  (typeof RelationshipCommitmentAcceptance)[keyof typeof RelationshipCommitmentAcceptance];

export const RelationshipCommitmentAcceptance = {
  candidate: "candidate",
