 ...
 */
export type BackgroundTaskRunCreateRequestExecutor =
  (typeof BackgroundTaskRunCreateRequestExecutor)[keyof typeof BackgroundTaskRunCreateRequestExecutor];

export const BackgroundTaskRunCreateRequestExecutor = {
  desktop: "desktop",
  api: "api",
} as const;
