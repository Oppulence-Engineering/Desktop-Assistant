...
export type ListBackgroundTaskRunsForAccountStatus =
  (typeof ListBackgroundTaskRunsForAccountStatus)[keyof typeof ListBackgroundTaskRunsForAccountStatus];

export const ListBackgroundTaskRunsForAccountStatus = {
  queued: "queued",
  running: "running",
  succeeded: "succeeded",
  failed: "failed",
