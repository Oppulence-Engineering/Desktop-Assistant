 ...
 */
import type { IngestRelationshipObservationsBodyObservationsItem } from "./ingestRelationshipObservationsBodyObservationsItem";

/**
 * Observation batch.
 */
export type IngestRelationshipObservationsBody = {
  /** Provider-neutral observations. */
  observations: IngestRelationshipObservationsBodyObservationsItem[];
};
