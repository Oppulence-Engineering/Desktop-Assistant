...
export type ListBackgroundTaskRunsExecutor =
  (typeof ListBackgroundTaskRunsExecutor)[keyof typeof ListBackgroundTaskRunsExecutor];

export const ListBackgroundTaskRunsExecutor = {
  desktop: "desktop",
  api: "api",
} as const;
