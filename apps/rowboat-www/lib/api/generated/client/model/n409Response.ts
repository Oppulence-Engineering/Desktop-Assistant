 ...
 */
import type { ReconnectErrorEnvelope } from "./reconnectErrorEnvelope";

/**
 * Conflict. Usually means an upstream refresh token is invalid and the user must reconnect.
 */
export type N409Response = ReconnectErrorEnvelope;
