 ...
 * Execution backend.
 */
export type BackgroundTaskRunPatchRequestExecutor =
  (typeof BackgroundTaskRunPatchRequestExecutor)[keyof typeof BackgroundTaskRunPatchRequestExecutor];

export const BackgroundTaskRunPatchRequestExecutor = {
  desktop: "desktop",
  api: "api",
} as const;
