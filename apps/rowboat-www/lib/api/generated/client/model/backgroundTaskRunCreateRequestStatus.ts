 ...
 */
export type BackgroundTaskRunCreateRequestStatus =
  (typeof BackgroundTaskRunCreateRequestStatus)[keyof typeof BackgroundTaskRunCreateRequestStatus];

export const BackgroundTaskRunCreateRequestStatus = {
  queued: "queued",
  running: "running",
  succeeded: "succeeded",
  failed: "failed",
