...
import { HeroChatReply } from "./hero-chat-reply";
import { HeroToolCallItem } from "./hero-tool-call-item";
import { HeroChatWelcome } from "../hero-chat-welcome/hero-chat-welcome";
import { HERO_TOOLTIP_OFFSET } from "../sidebar-hotspots";
import { useElapsedReveal } from "@/hooks/sim/use-elapsed-reveal";
import {
  type AgentGroupItem,
  AgentGroupView,
} from "@/sim-port/workspace/home/components/message-content/components/agent-group/agent-group-view";
import {
  parseQuestionAnswerMessage,
  QuestionDisplay,
} from "@/sim-port/workspace/home/components/message-content/components/question";
import type { QuestionItem } from "@/sim-port/workspace/home/components/message-content/components/special-tags";
import { PendingTagIndicator } from "@/sim-port/workspace/home/components/message-content/components/special-tags/pending-tag-indicator";
import { SendButton } from "@/sim-port/workspace/home/components/user-input/components/send-button/send-button";
...
const WORKFLOW_AGENT_ITEMS: AgentGroupItem[] = [
  {
    ...
    data: {
      ...
      displayTitle: "Read Gmail",
      status: ToolCallStatus.success,
      params: { toolId: "gmail_read_thread" },
    },
  },
  {
    type: "tool",
    data: {
      ...
      displayTitle: "Building Acme register flow",
      status: ToolCallStatus.success,
    },
  },
  {
    ...
    data: {
      id: "hero-read-table",
      toolName: "read",
      displayTitle: "Reading register",
      status: ToolCallStatus.success,
      params: { path: "register/acme/state.json" },
    },
  },
  {
    type: "text",
    content: "Connected Gmail, HubSpot, and the register gate",
  },
  {
    type: "tool",
    data: {
...
const SIM_ITEMS: AgentGroupItem[] = [
  {
    ...
    data: {
      ...
      status: ToolCallStatus.success,
      params: { path: "workflows/Acme%20register%20flow/state.json" },
    },
  },
];
...
const FOLLOW_UP_QUESTION: QuestionItem[] = [
  {
    ...
    options: [
      { id: "test", label: "Review the candidate rows" },
      { id: "deploy", label: "Confirm the register gate" },
    ],
  },
];
...
export type HeroChatPhase =
  "idle" | "compose" | "user" | "thinking" | "dispatching" | "building" | "reply";
    ...
    >
      ...
      >
        ...
        <textarea
          ...
          aria-label="Ask Oppulence"
          placeholder="Ask Oppulence to "
