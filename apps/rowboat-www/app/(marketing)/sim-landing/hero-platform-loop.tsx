...
import { HeroPlatformIntro } from "./hero-platform-intro";
import { type HeroResourceId, HeroResourcePanel } from "./hero-resource-panel";
import { PREVIEW_BUILD_TIMING } from "./preview-build-timing";
import { DEFAULT_REPLY_MESSAGE, DEFAULT_USER_MESSAGE } from "./preview-chat-content";
import { STAGE_BLOCKS } from "./stage-data";
import { HeroLoopShell } from "./shared/hero-loop-shell";
import { PREVIEW_SIDEBAR_CHATS, PREVIEW_SIDEBAR_WORKFLOWS } from "./shared/sidebar-preview-content";
import { useDragResize } from "@/hooks/sim/use-drag-resize";
    ...
    <HeroPlatformIntro onComplete={finishIntro}>
      ...
      >
        <div
          ...
          className="sim-product-preview relative flex h-full w-full overflow-hidden rounded-[6px] border border-[var(--border)] bg-[var(--bg)] [--preview-resource-width:50%]"
