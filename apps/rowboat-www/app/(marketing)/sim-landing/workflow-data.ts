...
import { AgentIcon, GithubIcon, JiraIcon } from "@/components/sim/icons";
import { CsvIcon, DocxIcon, MarkdownIcon, PdfIcon } from "@/components/sim/document-icons";
...
export type PromptAtom =
  { kind: "char"; char: string } | { kind: "mention"; label: string; icon: IconComponent };
