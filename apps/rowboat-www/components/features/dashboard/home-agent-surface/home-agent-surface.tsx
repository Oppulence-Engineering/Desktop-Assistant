...
export function HomeAgentSurface({
  ...
  return (
    ...
    >
      <div className="flex flex-1 flex-col justify-center px-4 py-10 md:px-8">
        <div className="mx-auto w-full max-w-xl">
          <div className="flex gap-5 md:gap-6">
            <div
              aria-hidden
              className="flex shrink-0 flex-col items-end pt-1 font-mono text-[10px] leading-none text-primary/18"
            >
              <span>01</span>
              <div className="mt-3 min-h-[88px] w-px flex-1 bg-primary/10" />
            </div>

            <div className="min-w-0 flex-1">
              <h1 className="text-[2rem] font-medium tracking-[-0.04em] text-primary md:text-[2.35rem]">
                Resolve.
              </h1>
              ...
              <div
                ...
                className={[
                  ...
                  "[&_[data-slot=input-group-control]]:placeholder:text-primary/20",
              ...
              <div className="mt-5 min-h-6">
                {motionReduced ? (
                  <div className="flex flex-wrap gap-x-3 gap-y-1 text-sm text-primary/35">
                    {STARTING_POINTS.map((startingPoint, index) => (
                      <span className="inline-flex items-center gap-3" key={startingPoint.label}>
                        ...
                        <button
                          className="font-normal transition-colors hover:text-primary/70"
                  ...
                  <button
                    className="text-left text-sm font-normal text-primary/35 transition-colors hover:text-primary/65"
              ...
              <p className="mt-10 font-mono text-[10px] tracking-[0.08em] text-primary/22">
      ...
      <div className="shrink-0">{signalPanel}</div>
    </section>
  );
}
