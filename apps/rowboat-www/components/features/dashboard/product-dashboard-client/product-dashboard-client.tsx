...
import { GoogleOAuthReturnHandler } from "@/components/features/connectors/google-oauth-return-handler/google-oauth-return-handler";
 ...
 */
export function ProductDashboardClient({ children, initialSession }: ProductDashboardClientProps) {
  return (
    <div className="contents" data-slot="product-dashboard-client">
