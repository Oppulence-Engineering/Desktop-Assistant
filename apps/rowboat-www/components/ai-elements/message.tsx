...
export function MessageAttachment({ data, className, onRemove, ...props }: MessageAttachmentProps) {
  ...
  return (
    <div
      className={cn("group relative size-24 overflow-hidden rounded-none", className)}
      {...props}
    >
      {isImage ? (
        <>
        ...
        <>
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="flex size-full shrink-0 items-center justify-center rounded-none bg-muted text-muted-foreground">
