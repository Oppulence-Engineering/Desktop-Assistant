...
| **Refs**         | Supersedes former cross-portfolio cockpit and Oppulence product integration plans; strategy reference: [`docs/one-pager-product.md`](../../docs/one-pager-product.md). |
