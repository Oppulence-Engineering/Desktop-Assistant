...
| **Depends on**   | [RFC 027](./027-durable-agent-runtime.md) durable agent runtime (the `AgentDefinition` shape, `internal/agentregistry`, `/v1/agents`) · [RFC 012](./012-connector-suite-and-consent-broker.md) scope catalog · [RFC 020](./020-native-third-party-action-engine.md) declarative OpenAPI/MCP tools · `internal/llm` model allowlist |
| **Related**      | [RFC 005](./complete-005-temporal-schedule-integration.md) reconciler pattern · [RFC 010](./010-rowboat-api-service-plane.md) service plane · [RFC 018](./018-a2a-delegation-and-agent-identity.md) delegation · [RFC 023](./023-closed-loop-actions.md) closed-loop actions                                                       |
