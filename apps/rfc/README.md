...
| #                                          | Title                                                                    | Layer              | What it adds                                                                                                                                                              |
| ------------------------------------------ | ------------------------------------------------------------------------ | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [021](./021-semantic-memory-index.md)      | Semantic Retrieval & Memory Index                                        | apps/x (+ api)     | A local, incremental embedding index over the vault + a `memory-search` builtin doing hybrid (vector + BM25) recall; lexical `file-grep` won't scale a large KB.          |
