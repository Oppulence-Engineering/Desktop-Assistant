...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **RFC**               | 001                                                                                                                                                                                                          |
| **Status**            | Complete — implemented (PRs 001-A…001-F) and merged to `develop` in PR #49. Single-replica only until [RFC 002](./002-durable-schedule-state.md) lands the durable lease.                                     |
