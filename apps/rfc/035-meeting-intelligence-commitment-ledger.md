...
| **Depends on**   | [RFC 009](./complete-009-local-on-device-transcription.md), [RFC 017](./complete-017-on-device-meeting-diarization.md), [RFC 030](./030-revenue-memory-outbound-governance.md), [email-013](./email-013-meeting-briefs-and-relationship-context.md) |
