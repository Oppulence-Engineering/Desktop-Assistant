...
| **Missing foundations** this RFC depends on                                                            | recall ([021](./complete-021-semantic-memory-index.md)), shared graph ([022](./022-unified-entity-graph.md)), closed-loop act ([023](./023-closed-loop-actions.md)), durable runtime ([025](./025-desktop-runtime-durability.md)) — all Draft |
...
| **P1 — Recall**            | [021](./complete-021-semantic-memory-index.md) semantic index                                                                                                            | Every workflow needs context retrieval that scales.                            |
