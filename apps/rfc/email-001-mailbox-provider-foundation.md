...
| Rowboat cloud already has normalized cloud events and Google watch infrastructure that can be reused for mailbox watches.                                                                                               | `apps/rfc/complete-003-cloud-event-ingestion.md`, `apps/rfc/019-google-push-infrastructure.md`, `apps/rowboat-api/ent/schema/cloud_event.go`, `apps/rowboat-api/ent/schema/google_watch.go` |
