...
| **Related**      | [RFC 009](./009-local-on-device-transcription.md), [RFC 012](./012-connector-suite-and-consent-broker.md), [RFC 013](./013-oppulence-product-connector-fabric.md), [RFC 018](./018-a2a-delegation-and-agent-identity.md)                                                                       |
| **Parent docs**  | [`docs/superpowers/plans/2026-05-20-rowboat-apps-architecture-map.md`](../../docs/superpowers/plans/2026-05-20-rowboat-apps-architecture-map.md), [`docs/IMPLEMENTATION_PLAN.md`](../../docs/IMPLEMENTATION_PLAN.md), [`docs/LOCAL_KIND_ROWBOAT_API.md`](../../docs/LOCAL_KIND_ROWBOAT_API.md) |
