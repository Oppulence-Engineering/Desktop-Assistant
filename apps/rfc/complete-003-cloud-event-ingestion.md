...
This RFC adds a **cloud event ingestion + routing layer** to the Oppulence API: accept
...
2. **Pass-1 candidacy** — a single bounded LLM call (via the Oppulence API LLM gateway,
