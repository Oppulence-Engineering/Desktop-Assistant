...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **RFC**          | 030                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Status**       | Complete — implemented in `apps/rowboat-api/internal/revenue` (+ `internal/revenuemetrics`, `internal/email`, `internal/embeddings`) and the rowboat-www **Revenue** console: the domain schema, the action-queue lifecycle enforcing the 11 hard invariants, the fail-closed OutboundConsole facade client, the Gmail draft/send executor, deterministic leak-scan detectors with explainable ranking, self-running + incremental scans, the ROI/impact view, the proactive digest email, execution-only billing gate, and PostHog analytics. Hardened via a 10-round adversarially-verified review. Deferred by design: the OutboundConsole facade itself (WP1, `lead-scraper-service` repo — unlocks governed _sending_; drafts-first until then), the transactional-outbox delivery worker, the WP0.6 server-verified link handshake, and WP6 team-scoped tenancy. |
...
| **Related**      | [RFC 036](./036-relationship-state-engine.md), [RFC 013](./013-oppulence-product-connector-fabric.md), [RFC 014](./014-live-note-observability-cost-and-provenance.md), [email-004](./email-004-reply-zero-and-drafting.md), [email-013](./email-013-meeting-briefs-and-relationship-context.md), [email-015](./email-015-email-privacy-security-and-governance.md), [email-016](./email-016-email-evaluation-and-quality-gates.md), [email-019](./email-019-multi-account-organizations-and-team-boundaries.md)                                                                                                                                                                                                                                                                                                                                                       |
...
Warm revenue recovery is the first detector over the broader relationship model:
...
The customer sees one relationship mission-control experience. The action queue is one workflow within it; the services retain independent ownership and deployment.
...
Rowboat now has durable relationships, commitments, an approval-gated RevenueAction lifecycle, workspace mapping, evidence storage, deterministic detectors, and outcome tracking. RFC 036 extends that implemented base with provider-neutral observations, assertions, snapshots, participants, source freshness, corrections, and equal web/desktop relationship surfaces.
...
10. **The living relationship model is the product.** The queue is a recommendation view over that state; agent definitions, Temporal, research sessions, and verification pipelines remain implementation details.
