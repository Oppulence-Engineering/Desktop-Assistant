  ...
  if (!prompt) {
    return (
      <NodeViewWrapper data-type="prompt-block">
        <div className="my-2 rounded-none border border-destructive/40 bg-destructive/5 p-3 text-sm text-destructive">
          Invalid prompt block — expected YAML with <code>label</code> and{" "}
  ...
  return (
    <NodeViewWrapper data-type="prompt-block">
      <div
        ...
        className="flex items-center gap-3 rounded-none border border-border bg-card p-3 pr-4 text-left transition-colors hover:bg-accent/50 cursor-pointer w-full my-2"
      >
        ...
        <Button
          variant="outline"
          size="sm"
          className="shrink-0 text-xs h-8 rounded-none pointer-events-none"
        >
          Run
        </Button>
      </div>
