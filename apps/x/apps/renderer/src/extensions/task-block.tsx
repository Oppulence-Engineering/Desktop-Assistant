    ...
    <NodeViewWrapper className="task-block-wrapper" data-type="task-block">
      <div className="task-block-card">
        ...
        <div className="task-block-content">
          <span className="task-block-instruction"><span className="task-block-prefix">@solomon</span> {instruction}</span>
          {processing && (
    ...
    return [
      {
        ...
        getAttrs(element) {
          ...
          if (cls.includes('language-task') || cls.includes('language-tell-solomon') || cls.includes('language-tell-rowboat')) {
