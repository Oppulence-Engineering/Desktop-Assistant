...
export function DocxFileViewer({ path }: DocxFileViewerProps) {
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden">
      ...
      {saveState !== "idle" && (
        <div className="pointer-events-none absolute bottom-3 right-4 z-10 rounded-none bg-background/80 px-2 py-1 text-xs text-muted-foreground shadow-sm backdrop-blur">
          {saveState === "saving"
            ? "Saving…"
            : saveState === "saved"
              ? "Saved"
