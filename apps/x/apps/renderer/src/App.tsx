...
function parseDeepLink(input: string): ViewState | null {
  const prefix = [`${DEEP_LINK_SCHEME}://`, `${LEGACY_DEEP_LINK_SCHEME}://`].find((value) => input.startsWith(value))
      ...
      <Dialog open={showMeetingPermissions} onOpenChange={setShowMeetingPermissions}>
        <DialogContent showCloseButton={false}>
          <DialogHeader>
            ...
            <DialogDescription>
              {PRODUCT_NAME} needs <strong>Screen Recording</strong> permission to capture meeting audio from other apps (Zoom, Meet, etc.). This feature won't work without it.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3 text-sm text-muted-foreground">
            ...
            <ol className="list-decimal list-inside space-y-1.5">
              ...
              <li>Toggle on <strong>{PRODUCT_NAME}</strong></li>
