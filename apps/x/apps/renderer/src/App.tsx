...
/**
 * Parse a product deep link into a ViewState. Returns null if the URL is
...
function App() {
  ...
  const handleCodePermissionResponse = useCallback(
    async (
      toolCallId: string,
      requestId: string,
          ...
          <CodingRunBlock
            ...
            onPermissionDecision={(decision) => {
              if (item.pendingCodePermission) {
                handleCodePermissionResponse(
                  item.id,
                  item.pendingCodePermission.requestId,
                  decision,
                );
              }
            }}
