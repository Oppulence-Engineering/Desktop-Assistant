...
Load this skill when creating or modifying agents that need access to Solomon AI's builtin tools (shell execution, file operations, etc.).
...
The Solomon AI copilot has access to special builtin tools that regular agents don't typically use. These tools help the copilot assist users with file management, app workflows, and MCP integration:
...
- \`loadSkill\` - Load a Solomon AI skill definition into context
