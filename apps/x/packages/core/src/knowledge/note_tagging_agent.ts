...
3. Classify the note using the Solomon AI Tag System (Note Tags section) appended below.
...
- Only use tag values from the Solomon AI Tag System — do not invent new tags.
...
9. **Only use tags from the Solomon AI Tag System** — do not invent new tags.
