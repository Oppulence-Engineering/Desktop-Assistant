export const PRODUCT_NAME = "Solomon AI";
export const PRODUCT_SLUG = "solomon-ai";
export const PRODUCT_ARTIFACT_NAME = "Solomon-AI";
...
export const LEGACY_DEEP_LINK_SCHEME = LEGACY_PRODUCT_PROVIDER_ID;

export const WORKDIR_ENV = "SOLOMON_WORKDIR";
export const LEGACY_WORKDIR_ENV = "ROWBOAT_WORKDIR";
export const DEFAULT_WORKDIR_NAME = ".solomon-ai";
...
export function getProductProviderState<T>(states: Record<string, T> | null | undefined): T | undefined {
