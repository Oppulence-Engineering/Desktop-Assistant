...
export function AssistantCard({
  ...
  const [showDescriptionToggle, setShowDescriptionToggle] =
    React.useState(false);
  ...
  return (
    <div
      onClick={onClick}
      className={clsx(
        "relative block p-4 border border-gray-200 dark:border-gray-700 rounded-none transition-all group text-left cursor-pointer",
        ...
        <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Share2
                size={14}
                className={copied ? "text-blue-600" : undefined}
              />
              {copied && (
                <span className="text-[10px] text-blue-600">Copied</span>
              )}
            </button>
          </div>
        </div>
