...
export function HelpModal({ isOpen, onClose, onStartTour }: HelpModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-100 flex items-center justify-center">
      <div className="bg-white dark:bg-zinc-800 rounded-none shadow-lg p-6 w-[480px] max-w-[90vw] animate-in fade-in duration-200">
        ...
        <div className="space-y-4">
          <Button
            ...
            onPress={onStartTour}
          >
            <div className="bg-indigo-100 dark:bg-indigo-500/20 p-2 rounded-none group-hover:bg-indigo-200 dark:group-hover:bg-indigo-500/30 transition-colors">
        ...
        <div className="mt-8 flex justify-end">
          <button
            onClick={onClose}
            className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 px-4 py-2 rounded-none hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-colors"
          >
            Close
          </button>
        </div>
