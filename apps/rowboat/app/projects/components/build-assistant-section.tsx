...
import {
  ...
  createProjectFromJsonWithOptions,
  createProjectFromTemplate,
} from "../lib/project-creation-utils";
...
import {
  loadSharedWorkflow,
  createSharedWorkflowFromJson,
} from "@/app/actions/shared-workflow.actions";
...
const copilotPrompts = {
  ...
  "Meeting prep workflow": {
    prompt:
      "Build a meeting prep pipeline which takes a google calendar invite as input and performs research on the guests using Duckduckgo search and send an email to me",
    emoji: "📅",
  },
  "Scheduling assistant": {
    prompt:
      "Build a scheduling assistant that helps users manage their calendar, book meetings, find available time slots, send reminders, and optimize their daily schedule based on priorities and preferences",
    emoji: "✅",
  },
  "Reddit & HN assistant": {
    prompt:
...
export function BuildAssistantSection() {
  ...
  const ensureTemplatesLoaded = useCallback(
    async (type: "prebuilt" | "community", targetCount: number) => {
              ...
              <div className="p-6 pb-0">
                ...
                >
                          ...
                          <div className="bg-white dark:bg-gray-800 rounded-none p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="relative group flex flex-col">
                              <TextareaWithSend
                                ...
                                className={clsx(
                                  "w-full rounded-none p-3 border border-gray-200 dark:border-gray-700",
                  ...
                  <Tab key="existing" title="My Assistants">
                    <div className="pt-4">
                      <div className="flex flex-col bg-white dark:bg-gray-800 rounded-none border border-gray-200 dark:border-gray-700 p-4">
                        {projectsLoading ? (
