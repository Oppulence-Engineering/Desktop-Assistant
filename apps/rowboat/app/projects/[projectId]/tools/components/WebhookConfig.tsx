      ...
      <div className="space-y-6">
        <div className="rounded-none border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden">
          <div className="px-6 pt-4">
            <h2 className="block text-sm font-semibold text-gray-900 dark:text-gray-100 mb-2">
              Webhook URL
            </h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
              In workflow editor, tool calls will be posted to this URL, unless
              they are mocked.
            </p>
          </div>
    ...
    <div className="space-y-6">
      <div className="rounded-none border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden">
        <div className="px-6 pt-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Tool calls will be posted to this URL, unless they are mocked.
          </p>
        </div>
        <div className="px-6 pb-6">
            ...
            {isEditMode ? (
              ...
              <>
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="light" onPress={handleEdit}>
                    Edit
                  </Button>
                </div>
              </>
