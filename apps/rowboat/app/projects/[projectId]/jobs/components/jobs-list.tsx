...
import {
  ListedJobItem,
  JobFiltersSchema,
} from "@/src/application/repositories/jobs.repository.interface";
                      ...
                      <table className="w-full">
                        <thead className="bg-gray-50 dark:bg-gray-800/50">
                          <tr>
                            ...
                            <th className="w-[25%] px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">
                              Reason
                            </th>
                            <th className="w-[25%] px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">
                              Created
