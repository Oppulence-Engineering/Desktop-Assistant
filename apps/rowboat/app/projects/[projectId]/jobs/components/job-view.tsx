              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-none border border-gray-200 dark:border-gray-700">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span
                      className={`ml-2 font-mono ${getStatusColor(job.status)}`}
                    >
                      {job.status}
                    </span>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="grid grid-cols-1 gap-2 text-sm">
                        {Object.entries(reasonInfo.details).map(
                          ([key, value]) => (
                    ...
                    {reasonInfo.payload &&
                      Object.keys(reasonInfo.payload).length > 0 && (
                        <div>
                          <div className="text-xs font-semibold text-gray-600 dark:text-gray-400 mb-2 uppercase tracking-wide">
                            Trigger Payload
                          </div>
                    ...
                    {reasonInfo.link && (
                      <div>
                        ...
                        >
                          {reasonInfo.type === "Scheduled Job Rule"
                            ? "View Scheduled Job Rule"
                            : "View Details"}
                        </Link>
                      </div>
                    )}
