...
} from "@/app/actions/recurring-job-rules.actions";
...
const convertFormMessagesToMessages = (
  messages: FormMessage[],
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="* * * * *"
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-none shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white font-mono"
                required
              />

              {showCronHelp && (
                <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-none">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                {messages.map((message, index) => (
                  <div
                    key={index}
                    className="border border-gray-200 dark:border-gray-700 rounded-none p-4"
                  >
                    <div className="flex items-center justify-between mb-3">
                      <select
                        value={message.role}
                        onChange={(e) =>
                          updateMessage(index, "role", e.target.value)
                        }
...
export function CreateRecurringJobRuleForm({
  ...
  const backButton: BackButtonConfig | undefined = hasExistingTriggers
    ? onBack
      ...
      : {
          label: "Back",
          href: `/projects/${projectId}/manage-triggers?tab=recurring`,
        }
    : undefined;
  ...
  return (
    <RecurringJobRuleFormBase
      ...
      successHref={
        onBack
          ? undefined
          : `/projects/${projectId}/manage-triggers?tab=recurring`
      }
    />
  );
}
