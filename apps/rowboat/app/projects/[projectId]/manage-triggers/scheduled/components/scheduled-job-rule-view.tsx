...
} from "@/app/actions/scheduled-job-rules.actions";
...
export function ScheduledJobRuleView({
  projectId,
  ruleId,
}: {
  projectId: string;
  ...
  const [rule, setRule] = useState<z.infer<typeof ScheduledJobRule> | null>(
    null,
  );
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-none border border-gray-200 dark:border-gray-700">
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <span
                            className={`ml-2 font-mono ${getStatusColor(rule.status, rule.processedAt || null)}`}
                          >
                            {getStatusText(
                              rule.status,
                              rule.processedAt || null,
                            )}
                          </span>
                        </div>
                        <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        {rule.input.messages.map((message, index) => (
                          <div
                            key={index}
                            className="bg-white dark:bg-gray-800 p-4 rounded-none border border-gray-200 dark:border-gray-700"
                          >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-none p-6 max-w-md mx-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
              Are you sure you want to delete this scheduled job rule? This
