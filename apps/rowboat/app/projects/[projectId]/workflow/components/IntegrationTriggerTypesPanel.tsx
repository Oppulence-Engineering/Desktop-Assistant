...
import { listIntegrationTriggerTypes } from "@/app/actions/integration.actions";
import { ZToolkit } from "@/src/application/lib/integration/types";
import { PictureImg } from "@/components/ui/picture-img";

interface IntegrationTriggerTypesPanelProps {
...
export function IntegrationTriggerTypesPanel({
  toolkit,
  onBack,
  onSelectTriggerType,
  initialTriggerTypeSlug,
}: IntegrationTriggerTypesPanelProps) {
  ...
  const loadTriggerTypes = useCallback(
    async (resetList = false, nextCursor?: string) => {
      try {
        ...
        const response = await listIntegrationTriggerTypes(
          toolkit.slug,
          nextCursor,
        );
