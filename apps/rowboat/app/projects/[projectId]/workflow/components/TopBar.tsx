...
export function TopBar({
  ...
  const projectId =
    typeof (params as any).projectId === "string"
  ...
  const progressSteps: ProgressStep[] = [
    {
      id: 1,
      label:
        "Build: Ask the copilot to create your assistant. Add tools and connect data sources.",
    ...
    },
    {
      id: 2,
      label:
        "Test: Test out your assistant by chatting with it. Use 'Fix' and 'Explain' to improve it.",
    ...
    // Removed the 'Publish' step from the progress bar
    {
      id: 4,
      label:
        "Use: Click the 'Use Assistant' button to chat, set triggers (like emails), or connect via API.",
  ...
  return (
    <>
      <div className="rounded-none bg-white/70 dark:bg-zinc-800/70 shadow-sm backdrop-blur-sm border border-zinc-200 dark:border-zinc-800 px-5 py-2">
            ...
            <div className="flex flex-col min-w-0 max-w-xs">
              <Input
                ...
                classNames={{
                  ...
                  inputWrapper:
                    "min-h-[36px] h-[36px] border-gray-200 dark:border-gray-700 px-0",
                }}
              />
            </div>
            ...
            {showBuildModeBanner && (
              <div className="flex items-center gap-2 mr-4">
                ...
                <div className="text-blue-700 dark:text-blue-300 text-sm">
                  Switched to draft mode. You can now make changes to your
                  workflow.
                </div>
              </div>
            )}
                    ...
                    <Dropdown>
                      <DropdownTrigger>
                        <Button
                          ...
                          className="h-8 min-w-0 bg-transparent text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100/60 dark:hover:bg-zinc-800/50 border border-transparent gap-1 px-2"
                        >
                          {/* 3-pane layout icon */}
                          <svg
                            width="26"
                      ...
                      >
                        <DropdownItem
                          key="show-all"
                          isDisabled={disableShowAll}
                          className={
                            selectedKey === "show-all"
                          ...
                          startContent={
                            <input
                              type="radio"
                              readOnly
                              checked={selectedKey === "show-all"}
                              className="accent-zinc-600 dark:accent-zinc-300"
                            />
                          }
                        >
                          Show All
                        ...
                        <DropdownItem
                          key="hide-agents"
                          isDisabled={disableHideAgents}
                          className={
                            selectedKey === "hide-agents"
                              ? "bg-zinc-100 dark:bg-zinc-800"
                              : ""
                          }
                          startContent={
                            <input
                              type="radio"
                              readOnly
                              checked={selectedKey === "hide-agents"}
                              className="accent-zinc-600 dark:accent-zinc-300"
                            />
                          }
                        >
                        ...
                        <DropdownItem
                          key="hide-chat"
                          isDisabled={disableHideChat}
                          className={
                            selectedKey === "hide-chat"
                              ? "bg-zinc-100 dark:bg-zinc-800"
                              : ""
                          }
                          startContent={
                        ...
                        <DropdownItem
                          key="hide-skipper"
                          isDisabled={disableHideSkipper}
                          className={
                            selectedKey === "hide-skipper"
                              ? "bg-zinc-100 dark:bg-zinc-800"
                              : ""
                          }
                          startContent={
                            <input
                              type="radio"
                              readOnly
                              checked={selectedKey === "hide-skipper"}
                              className="accent-zinc-600 dark:accent-zinc-300"
                            />
                          }
                        >
                    ...
                    <DropdownMenu aria-label="Assistant access options">
                      ...
                      <DropdownItem
                        ...
                        onPress={() => {
                          ...
                          if (projectId) {
                            router.push(
                              `/projects/${projectId}/manage-triggers`,
                            );
                          }
                        }}
                      >
      ...
      <Modal
        ...
        classNames={{
          ...
          header:
            "border-b border-gray-200 dark:border-gray-700 pb-4 flex-shrink-0",
          body: "py-6 overflow-y-auto flex-1",
          footer:
            "border-t border-gray-200 dark:border-gray-700 pt-4 flex-shrink-0",
        }}
      >
        <ModalContent>
          ...
          <ModalBody>
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-none bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                    <ShareIcon
                      size={16}
                ...
                {shareUrl ? (
                  <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-none border border-gray-200 dark:border-gray-700">
                    ...
                    <Button
                      ...
                      className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-none font-medium"
                    >
                      {copyButtonText}
                    </Button>
                  </div>
              ...
              {SHOW_COMMUNITY_PUBLISH && (
                <div className="relative">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-4 bg-white dark:bg-gray-900 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider">
                      or
                    </span>
                  </div>
                </div>
              ...
              {SHOW_COMMUNITY_PUBLISH && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-none bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center">
                      <MessageCircleIcon
                        size={16}
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        classNames={{
                          input:
                            "text-sm focus:outline-none !focus:ring-0 !focus:ring-offset-0 !ring-0 !ring-offset-0",
                          inputWrapper:
                            "border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 focus-within:border-gray-300 dark:focus-within:border-gray-500 !focus-within:ring-0 !focus-within:ring-offset-0 !ring-0 !ring-offset-0",
                        }}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        selectedKeys={
                          communityData.category ? [communityData.category] : []
                        }
                        onSelectionChange={(keys) => {
                        ...
                        classNames={{
                          trigger:
                            "border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 focus:outline-none !focus:ring-0 !focus:ring-offset-0 !ring-0 !ring-offset-0 focus-within:border-gray-300 dark:focus-within:border-gray-500 !focus-within:ring-0 !focus-within:ring-offset-0",
                          value: "text-sm",
                        }}
                      >
                        <SelectItem key="Work Productivity">
                          Work Productivity
                        </SelectItem>
                        <SelectItem key="Developer Productivity">
                          Developer Productivity
                        </SelectItem>
                        <SelectItem key="News & Social">
                          News & Social
                        </SelectItem>
                        <SelectItem key="Customer Support">
                          Customer Support
                        </SelectItem>
                        <SelectItem key="Education">Education</SelectItem>
                        <SelectItem key="Entertainment">
                          Entertainment
                        </SelectItem>
                    ...
                    {/* Privacy Toggle */}
                    <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/30 rounded-none border border-gray-200 dark:border-gray-700">
                      <div className="flex-1">
                        <div className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1">
                          {communityData.isAnonymous
                            ? "Publish anonymously"
                            : `Publish as ${getUserDisplayName()}`}
                        </div>
                      ...
                      <button
                        ...
                        onClick={() =>
                          setCommunityData({
                            ...communityData,
                            isAnonymous: !communityData.isAnonymous,
                          })
                        }
                    ...
                    {/* Success Message */}
                    {communityPublishSuccess && (
                      <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-none">
          ...
          <ModalContent>
            <ModalHeader>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">
                Confirm publish to community
              </h3>
            </ModalHeader>
            <ModalBody>
              <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                <p>
                  Publishing to community will make this assistant and its
                  description publicly visible to other users.
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Your assistant may appear in the community templates
                    library.
                  </li>
                  <li>
                    Others can import and use this assistant in their own
                    projects.
                  </li>
                  <li>
                    Do not include secrets or private data in the description or
                    workflow.
                  </li>
                </ul>
                <div className="mt-3 flex items-start gap-2">
                  ...
                  />
                  <label htmlFor="ack-publish" className="text-sm">
