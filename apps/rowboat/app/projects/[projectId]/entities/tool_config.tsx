...
export function ParameterConfig({
  ...
  return (
    <div className="rounded-none bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 space-y-4">
...
export function ToolConfig({
  ...
  const renderParameters = () => {
    ...
    return Object.entries(tool.parameters.properties).map(
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 pb-4 pt-4 p-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            {tool.mockTool && (
              <div className="flex flex-col gap-1 mt-4">
                <label className="text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1">
                  Mock Response Instructions
                </label>
                <span className="text-xs text-gray-500 dark:text-gray-400 mb-1">
                  Describe the response the mock tool should return. This will
                  be shown in the chat when the tool is called.
                </span>
                <InputField
                  type="text"
                ...
                ([paramName, param]) => (
                  <ToolParamCard
                    ...
                    param={{
                      ...
                      type: param.type,
                      required:
                        tool.parameters?.required?.includes(paramName) ?? false,
                    }}
                    handleUpdate={handleParamUpdate}
                    handleDelete={handleParamDelete}
                    handleRename={handleParamRename}
        ...
        {/* Tool Type Section */}
        {!tool.isLibrary && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200 dark:border-blue-800 rounded-none p-4">
                ...
                {tool.isWebhook && (
                  <div className="text-sm text-gray-700 dark:text-gray-300">
                    <div className="flex items-center gap-1 mb-1">
                      <p>
                        This tool is invoked using the webhook configured in{" "}
                        <Link
