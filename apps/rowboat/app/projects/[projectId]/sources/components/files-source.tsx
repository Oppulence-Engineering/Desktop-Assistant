...
import {
  deleteDocFromDataSource,
  getUploadUrlsForFilesDataSource,
  addDocsToDataSource,
  getDownloadUrlForFile,
  listDocsInDataSource,
...
function FileListItem({
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-none border border-gray-200 dark:border-gray-700">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          uploaded <RelativeTime date={new Date(file.createdAt)} /> -{" "}
  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-800/50 rounded-none">
...
export function FilesSource({
  ...
  const onDrop = useCallback(
    async (acceptedFiles: File[]) => {
      setUploading(true);
      try {
        const urls = await getUploadUrlsForFilesDataSource(
          dataSource.id,
