      ...
      <div className="h-full overflow-auto px-4 py-4">
        <div className="max-w-[1024px] mx-auto">
          ...
          {!loading && sources.length > 0 && (
            <>
              <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/10 rounded-none border border-blue-200 dark:border-blue-800">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-700 dark:text-blue-300">
                    After creating data sources, go to the RAG tab inside
                    individual agent settings to connect them to agents.
                  </div>
                </div>
              </div>
