...
const MentionsEditor = dynamic(() => import("./mentions_editor"), {
  ssr: false,
});
...
function TextInputField({
        ...
        {mentions ? (
          ...
          <Textarea
            ...
            classNames={{
              ...
              inputWrapper:
                "border-gray-200 dark:border-gray-700 focus-within:ring-0 focus-within:outline-none",
            }}
          />
        ) : (
          <Input
  ...
  return (
    <div ref={ref} className={clsx("w-full", className)}>
      ...
      <div
        className={clsx(
          "group relative rounded-none border border-gray-200 dark:border-gray-700 p-3 transition-all duration-200",
          {
            "cursor-pointer hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800":
              !locked && !disabled,
...
function NumberInputField({
  ...
  return (
    <div ref={ref} className={clsx("w-full", className)}>
      ...
      <div
        className={clsx(
          "group relative rounded-none border border-gray-200 dark:border-gray-700 p-3 min-h-[40px] transition-all duration-200",
          {
            "cursor-pointer hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800":
              !locked && !disabled,
            "cursor-not-allowed opacity-60": locked || disabled,
