...
function ToolCallDisplay({ toolCall }: { toolCall: any }) {
  return (
    <div className="bg-gray-50 dark:bg-gray-800 p-3 rounded-none border border-gray-200 dark:border-gray-700">
...
export function MessageDisplay({
  ...
  const getBubbleStyle = () => {
    if (isUser) {
      return "ml-auto max-w-[80%] bg-blue-100 text-blue-900 border border-blue-200 rounded-none rounded-br-md";
    } else if (isAssistant) {
      if (isInternal) {
        return "mr-auto max-w-[80%] bg-gray-50 text-gray-700 border border-dotted border-gray-300 rounded-none rounded-bl-md";
      } else {
        return "mr-auto max-w-[80%] bg-green-100 text-green-900 border border-green-200 rounded-none rounded-bl-md";
      }
    } else if (isSystem) {
      return "mx-auto max-w-[90%] bg-yellow-100 text-yellow-900 border border-yellow-200 rounded-none";
    } else if (isTool) {
      return "mr-auto max-w-[80%] bg-purple-100 text-purple-900 border border-purple-200 rounded-none rounded-bl-md";
    }
    return "mx-auto max-w-[80%] bg-gray-100 text-gray-900 border border-gray-200 rounded-none";
  };
