...
import { listTools } from "@/src/application/lib/integration/integration";
import { ZListResponse } from "../../lib/integration/types";
import { ZTool } from "../../lib/integration/types";
...
export interface IListIntegrationToolsUseCase {
    execute(request: z.infer<typeof InputSchema>): Promise<z.infer<ReturnType<typeof ZListResponse<typeof ZTool>>>>;
}

export class ListIntegrationToolsUseCase implements IListIntegrationToolsUseCase {
