...
import { getToolkit } from "@/src/application/lib/integration/integration";
import { ZGetToolkitResponse } from "../../lib/integration/types";
...
export interface IGetIntegrationToolkitUseCase {
    execute(request: z.infer<typeof InputSchema>): Promise<z.infer<typeof ZGetToolkitResponse>>;
}

export class GetIntegrationToolkitUseCase implements IGetIntegrationToolkitUseCase {
