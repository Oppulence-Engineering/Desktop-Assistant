...
export const ZToolkit = z.object({
  ...
  integration_managed_auth_schemes: z.array(ZAuthScheme),
});

export const ZIntegrationField = z.object({
  name: z.string(),
      ...
      z.object({
        ...
        fields: z.object({
          auth_config_creation: z.object({
            required: z.array(ZIntegrationField),
            optional: z.array(ZIntegrationField),
          }),
...
export const ZAuthConfig = z.object({
  id: z.string(),
  is_integration_managed: z.boolean(),
...
export const ZCreateAuthConfigRequest = z.object({
  ...
  auth_config: z
    .discriminatedUnion("type", [
      z.object({
        type: z.literal("use_integration_managed_auth"),
...
export const ZConnectionData = z.object({
  authScheme: ZAuthScheme,
  val: z.record(z.string(), z.unknown()).and(
    z.object({
...
/*
{
    ...
    "connectionData": {
        ...
        "val": {
            ...
            "redirectUrl": "https://backend.integration.dev/api/v3/s/DbTOWAyR",
            "callback_url": "https://backend.integration.dev/api/v1/auth-apps/add"
        }
    },
    "status": "INITIATED",
    "redirect_url": "https://backend.integration.dev/api/v3/s/DbTOWAyR",
    "redirect_uri": "https://backend.integration.dev/api/v3/s/DbTOWAyR",
    "deprecated": {
        "uuid": "00000000-0000-4000-8000-000000000001",
        "authConfigUuid": "00000000-0000-4000-8000-000000000002"
    }
}
*/
...
export const ZError = z.object({
  error: z.enum(["CUSTOM_OAUTH2_CONFIG_REQUIRED"]),
});
...
export const ZListResponse = <T extends z.ZodTypeAny>(schema: T) =>
  z.object({
