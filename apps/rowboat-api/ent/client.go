...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.AgentApproval, c.AgentDefinition, c.AgentSession, c.AgentSessionEvent,
		c.AgentToolCall, c.AgentToolResultBlob, c.AgentTurn, c.BackgroundTask,
		c.BackgroundTaskArtifact, c.BackgroundTaskRun, c.BackgroundTaskRunEvent,
		c.BackgroundTaskScheduleState, c.CloudEvent, c.ComposioAccount, c.CreditLedger,
...
type (
	hooks struct {
		AgentApproval, AgentDefinition, AgentSession, AgentSessionEvent, AgentToolCall,
		AgentToolResultBlob, AgentTurn, BackgroundTask, BackgroundTaskArtifact,
		BackgroundTaskRun, BackgroundTaskRunEvent, BackgroundTaskScheduleState,
		CloudEvent, ComposioAccount, CreditLedger, GoogleWatch, LLMUsage,
		LLMUsageHistory, MCPConnection, MCPConnectionHistory, MeetingMinuteUsage,
