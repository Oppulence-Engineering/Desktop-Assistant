...
func (_c *RelationshipCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if relationship.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized relationship.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := relationship.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if relationship.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized relationship.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if relationship.DefaultID == nil {
			return fmt.Errorf("ent: uninitialized relationship.DefaultID (forgotten import ent/runtime?)")
		}
