...
var (
	...
	CommitmentsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "commitment_status_due_at_revenue_workspace_id",
				Unique:  false,
				Columns: []*schema.Column{CommitmentsColumns[5], CommitmentsColumns[6], CommitmentsColumns[20]},
			},
			{
				Name:    "commitment_direction_status_revenue_workspace_id",
				Unique:  false,
				Columns: []*schema.Column{CommitmentsColumns[3], CommitmentsColumns[5], CommitmentsColumns[20]},
			},
		},
	}
	...
	RevenueLeakScansColumns = []*schema.Column{
		...
		{Name: "extraction_failures", Type: field.TypeInt, Default: 0},
		{Name: "started_at", Type: field.TypeTime, Nullable: true},
		{Name: "completed_at", Type: field.TypeTime, Nullable: true},
		{Name: "error", Type: field.TypeString, Nullable: true, Size: 2147483647},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{RevenueLeakScansColumns[3], RevenueLeakScansColumns[21]},
			},
			{
