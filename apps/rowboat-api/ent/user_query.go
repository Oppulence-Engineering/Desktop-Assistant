...
func (_q *UserQuery) QueryCommitmentEvents() *CommitmentEventQuery {
...
func (_q *UserQuery) QueryCommitmentDependencies() *CommitmentDependencyQuery {
...
func (_q *UserQuery) QueryConversationIntelligenceArtifacts() *ConversationIntelligenceArtifactQuery {
...
func (_q *UserQuery) QueryRelationshipIdentities() *RelationshipIdentityQuery {
...
func (_q *UserQuery) QueryRelationshipAssertions() *RelationshipAssertionQuery {
...
func (_q *UserQuery) QueryRelationshipStateSnapshots() *RelationshipStateSnapshotQuery {
...
func (_q *UserQuery) QueryRelationshipSourceStatuses() *RelationshipSourceStatusQuery {
...
func (_q *UserQuery) WithCommitmentEvents(opts ...func(*CommitmentEventQuery)) *UserQuery {
	query := (&CommitmentEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithCommitmentDependencies(opts ...func(*CommitmentDependencyQuery)) *UserQuery {
	query := (&CommitmentDependencyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithConversationIntelligenceArtifacts(opts ...func(*ConversationIntelligenceArtifactQuery)) *UserQuery {
	query := (&ConversationIntelligenceArtifactClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithRelationshipIdentities(opts ...func(*RelationshipIdentityQuery)) *UserQuery {
	query := (&RelationshipIdentityClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithRelationshipAssertions(opts ...func(*RelationshipAssertionQuery)) *UserQuery {
	query := (&RelationshipAssertionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithRelationshipStateSnapshots(opts ...func(*RelationshipStateSnapshotQuery)) *UserQuery {
	query := (&RelationshipStateSnapshotClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithRelationshipSourceStatuses(opts ...func(*RelationshipSourceStatusQuery)) *UserQuery {
	query := (&RelationshipSourceStatusClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withCommitmentEvents; query != nil {
		if err := _q.loadCommitmentEvents(ctx, query, nodes,
			func(n *User) { n.Edges.CommitmentEvents = []*CommitmentEvent{} },
			func(n *User, e *CommitmentEvent) { n.Edges.CommitmentEvents = append(n.Edges.CommitmentEvents, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCommitmentDependencies; query != nil {
		if err := _q.loadCommitmentDependencies(ctx, query, nodes,
			func(n *User) { n.Edges.CommitmentDependencies = []*CommitmentDependency{} },
			func(n *User, e *CommitmentDependency) {
	...
	if query := _q.withConversationIntelligenceArtifacts; query != nil {
		if err := _q.loadConversationIntelligenceArtifacts(ctx, query, nodes,
			func(n *User) { n.Edges.ConversationIntelligenceArtifacts = []*ConversationIntelligenceArtifact{} },
			func(n *User, e *ConversationIntelligenceArtifact) {
	...
	if query := _q.withRelationshipParticipants; query != nil {
		if err := _q.loadRelationshipParticipants(ctx, query, nodes,
			...
			func(n *User, e *RelationshipParticipant) {
	...
	if query := _q.withRelationshipObservations; query != nil {
		if err := _q.loadRelationshipObservations(ctx, query, nodes,
			...
			func(n *User, e *RelationshipObservation) {
	...
	if query := _q.withRelationshipAssertions; query != nil {
		if err := _q.loadRelationshipAssertions(ctx, query, nodes,
			func(n *User) { n.Edges.RelationshipAssertions = []*RelationshipAssertion{} },
			func(n *User, e *RelationshipAssertion) {
	...
	if query := _q.withRelationshipStateSnapshots; query != nil {
		if err := _q.loadRelationshipStateSnapshots(ctx, query, nodes,
			func(n *User) { n.Edges.RelationshipStateSnapshots = []*RelationshipStateSnapshot{} },
			func(n *User, e *RelationshipStateSnapshot) {
	...
	if query := _q.withRelationshipSourceStatuses; query != nil {
		if err := _q.loadRelationshipSourceStatuses(ctx, query, nodes,
			func(n *User) { n.Edges.RelationshipSourceStatuses = []*RelationshipSourceStatus{} },
	...
	for name, query := range _q.withNamedCommitmentEvents {
		if err := _q.loadCommitmentEvents(ctx, query, nodes,
			func(n *User) { n.appendNamedCommitmentEvents(name) },
			func(n *User, e *CommitmentEvent) { n.appendNamedCommitmentEvents(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedCommitmentDependencies {
		if err := _q.loadCommitmentDependencies(ctx, query, nodes,
			func(n *User) { n.appendNamedCommitmentDependencies(name) },
			func(n *User, e *CommitmentDependency) { n.appendNamedCommitmentDependencies(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedConversationIntelligenceArtifacts {
		if err := _q.loadConversationIntelligenceArtifacts(ctx, query, nodes,
			func(n *User) { n.appendNamedConversationIntelligenceArtifacts(name) },
			func(n *User, e *ConversationIntelligenceArtifact) {
	...
	for name, query := range _q.withNamedRelationshipParticipants {
		if err := _q.loadRelationshipParticipants(ctx, query, nodes,
			...
			func(n *User, e *RelationshipParticipant) { n.appendNamedRelationshipParticipants(name, e) }); err != nil {
			return nil, err
		}
	}
	...
	for name, query := range _q.withNamedRelationshipObservations {
		if err := _q.loadRelationshipObservations(ctx, query, nodes,
			func(n *User) { n.appendNamedRelationshipObservations(name) },
			func(n *User, e *RelationshipObservation) { n.appendNamedRelationshipObservations(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedRelationshipAssertions {
		if err := _q.loadRelationshipAssertions(ctx, query, nodes,
			func(n *User) { n.appendNamedRelationshipAssertions(name) },
			func(n *User, e *RelationshipAssertion) { n.appendNamedRelationshipAssertions(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedRelationshipStateSnapshots {
		if err := _q.loadRelationshipStateSnapshots(ctx, query, nodes,
			func(n *User) { n.appendNamedRelationshipStateSnapshots(name) },
			func(n *User, e *RelationshipStateSnapshot) { n.appendNamedRelationshipStateSnapshots(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *UserQuery) loadCommitmentEvents(ctx context.Context, query *CommitmentEventQuery, nodes []*User, init func(*User), assign func(*User, *CommitmentEvent)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.CommitmentEvent(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.CommitmentEventsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_commitment_events
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_commitment_events" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_commitment_events" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadCommitmentDependencies(ctx context.Context, query *CommitmentDependencyQuery, nodes []*User, init func(*User), assign func(*User, *CommitmentDependency)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.CommitmentDependency(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.CommitmentDependenciesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_commitment_dependencies
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_commitment_dependencies" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_commitment_dependencies" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadConversationIntelligenceArtifacts(ctx context.Context, query *ConversationIntelligenceArtifactQuery, nodes []*User, init func(*User), assign func(*User, *ConversationIntelligenceArtifact)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.ConversationIntelligenceArtifact(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.ConversationIntelligenceArtifactsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_conversation_intelligence_artifacts
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_conversation_intelligence_artifacts" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_conversation_intelligence_artifacts" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *UserQuery) loadRelationshipParticipants(ctx context.Context, query *RelationshipParticipantQuery, nodes []*User, init func(*User), assign func(*User, *RelationshipParticipant)) error {
	...
	query.Where(predicate.RelationshipParticipant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RelationshipParticipantsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_relationship_participants
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_relationship_participants" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_relationship_participants" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadRelationshipIdentities(ctx context.Context, query *RelationshipIdentityQuery, nodes []*User, init func(*User), assign func(*User, *RelationshipIdentity)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.RelationshipIdentity(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RelationshipIdentitiesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_relationship_identities
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_relationship_identities" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_relationship_identities" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *UserQuery) loadRelationshipObservations(ctx context.Context, query *RelationshipObservationQuery, nodes []*User, init func(*User), assign func(*User, *RelationshipObservation)) error {
	...
	query.Where(predicate.RelationshipObservation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RelationshipObservationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_relationship_observations
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_relationship_observations" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_relationship_observations" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadRelationshipAssertions(ctx context.Context, query *RelationshipAssertionQuery, nodes []*User, init func(*User), assign func(*User, *RelationshipAssertion)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.RelationshipAssertion(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RelationshipAssertionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_relationship_assertions
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_relationship_assertions" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_relationship_assertions" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadRelationshipStateSnapshots(ctx context.Context, query *RelationshipStateSnapshotQuery, nodes []*User, init func(*User), assign func(*User, *RelationshipStateSnapshot)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.RelationshipStateSnapshot(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RelationshipStateSnapshotsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_relationship_state_snapshots
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_relationship_state_snapshots" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_relationship_state_snapshots" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadRelationshipSourceStatuses(ctx context.Context, query *RelationshipSourceStatusQuery, nodes []*User, init func(*User), assign func(*User, *RelationshipSourceStatus)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.RelationshipSourceStatus(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RelationshipSourceStatusesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_relationship_source_statuses
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_relationship_source_statuses" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedCommitmentEvents(name string, opts ...func(*CommitmentEventQuery)) *UserQuery {
	query := (&CommitmentEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedCommitmentDependencies(name string, opts ...func(*CommitmentDependencyQuery)) *UserQuery {
	query := (&CommitmentDependencyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedConversationIntelligenceArtifacts(name string, opts ...func(*ConversationIntelligenceArtifactQuery)) *UserQuery {
	query := (&ConversationIntelligenceArtifactClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedRelationshipIdentities(name string, opts ...func(*RelationshipIdentityQuery)) *UserQuery {
	query := (&RelationshipIdentityClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedRelationshipObservations(name string, opts ...func(*RelationshipObservationQuery)) *UserQuery {
	query := (&RelationshipObservationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedRelationshipAssertions(name string, opts ...func(*RelationshipAssertionQuery)) *UserQuery {
	query := (&RelationshipAssertionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedRelationshipStateSnapshots(name string, opts ...func(*RelationshipStateSnapshotQuery)) *UserQuery {
	query := (&RelationshipStateSnapshotClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedRelationshipSourceStatuses(name string, opts ...func(*RelationshipSourceStatusQuery)) *UserQuery {
	query := (&RelationshipSourceStatusClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
