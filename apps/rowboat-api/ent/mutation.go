...
const (
	...
	TypeComposioAccount             = "ComposioAccount"
...
// ComposioAccountMutation represents an operation that mutates the ComposioAccount nodes in the graph.
type ComposioAccountMutation struct {
	config
	op            Op
	typ           string
	id            *uuid.UUID
	...
	oldValue      func(context.Context) (*ComposioAccount, error)
	predicates    []predicate.ComposioAccount
}

var _ ent.Mutation = (*ComposioAccountMutation)(nil)

// composioaccountOption allows management of the mutation configuration using functional options.
type composioaccountOption func(*ComposioAccountMutation)

// newComposioAccountMutation creates new mutation for the ComposioAccount entity.
func newComposioAccountMutation(c config, op Op, opts ...composioaccountOption) *ComposioAccountMutation {
	m := &ComposioAccountMutation{
		config:        c,
		op:            op,
		typ:           TypeComposioAccount,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withComposioAccountID sets the ID field of the mutation.
func withComposioAccountID(id uuid.UUID) composioaccountOption {
	return func(m *ComposioAccountMutation) {
		var (
			err   error
			once  sync.Once
			value *ComposioAccount
		)
		m.oldValue = func(ctx context.Context) (*ComposioAccount, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ComposioAccount.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withComposioAccount sets the old ComposioAccount of the mutation.
func withComposioAccount(node *ComposioAccount) composioaccountOption {
	return func(m *ComposioAccountMutation) {
		m.oldValue = func(context.Context) (*ComposioAccount, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m ComposioAccountMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m ComposioAccountMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of ComposioAccount entities.
func (m *ComposioAccountMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ComposioAccountMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ComposioAccountMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ComposioAccount.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *ComposioAccountMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *ComposioAccountMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the ComposioAccount entity.
// If the ComposioAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ComposioAccountMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *ComposioAccountMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *ComposioAccountMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *ComposioAccountMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the ComposioAccount entity.
// If the ComposioAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ComposioAccountMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *ComposioAccountMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetAccountID sets the "account_id" field.
func (m *ComposioAccountMutation) SetAccountID(s string) {
	m.account_id = &s
}

// AccountID returns the value of the "account_id" field in the mutation.
func (m *ComposioAccountMutation) AccountID() (r string, exists bool) {
	v := m.account_id
	if v == nil {
		return
	}
...
// OldAccountID returns the old "account_id" field's value of the ComposioAccount entity.
// If the ComposioAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ComposioAccountMutation) OldAccountID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ComposioAccountMutation) ResetAccountID() {
	m.account_id = nil
}

// SetToolkit sets the "toolkit" field.
func (m *ComposioAccountMutation) SetToolkit(s string) {
	m.toolkit = &s
}

// Toolkit returns the value of the "toolkit" field in the mutation.
func (m *ComposioAccountMutation) Toolkit() (r string, exists bool) {
	v := m.toolkit
	if v == nil {
		return
	}
...
// OldToolkit returns the old "toolkit" field's value of the ComposioAccount entity.
// If the ComposioAccount object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ComposioAccountMutation) OldToolkit(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldToolkit is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldToolkit requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldToolkit: %w", err)
	}
	return oldValue.Toolkit, nil
}

// ClearToolkit clears the value of the "toolkit" field.
func (m *ComposioAccountMutation) ClearToolkit() {
	m.toolkit = nil
	m.clearedFields[composioaccount.FieldToolkit] = struct{}{}
}

// ToolkitCleared returns if the "toolkit" field was cleared in this mutation.
func (m *ComposioAccountMutation) ToolkitCleared() bool {
	_, ok := m.clearedFields[composioaccount.FieldToolkit]
	return ok
}

// ResetToolkit resets all changes to the "toolkit" field.
func (m *ComposioAccountMutation) ResetToolkit() {
	m.toolkit = nil
	delete(m.clearedFields, composioaccount.FieldToolkit)
}

// SetUserID sets the "user" edge to the User entity by id.
func (m *ComposioAccountMutation) SetUserID(id uuid.UUID) {
	m.user = &id
}

// ClearUser clears the "user" edge to the User entity.
func (m *ComposioAccountMutation) ClearUser() {
	m.cleareduser = true
}

// UserCleared reports if the "user" edge to the User entity was cleared.
func (m *ComposioAccountMutation) UserCleared() bool {
	return m.cleareduser
}

// UserID returns the "user" edge ID in the mutation.
func (m *ComposioAccountMutation) UserID() (id uuid.UUID, exists bool) {
	if m.user != nil {
		return *m.user, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UserID instead. It exists only for internal usage by the builders.
func (m *ComposioAccountMutation) UserIDs() (ids []uuid.UUID) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetUser resets all changes to the "user" edge.
func (m *ComposioAccountMutation) ResetUser() {
	m.user = nil
	m.cleareduser = false
}

// Where appends a list predicates to the ComposioAccountMutation builder.
func (m *ComposioAccountMutation) Where(ps ...predicate.ComposioAccount) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ComposioAccountMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ComposioAccountMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ComposioAccount, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *ComposioAccountMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ComposioAccountMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ComposioAccount).
func (m *ComposioAccountMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *ComposioAccountMutation) Fields() []string {
	fields := make([]string, 0, 4)
	if m.created_at != nil {
		fields = append(fields, composioaccount.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, composioaccount.FieldUpdatedAt)
	}
	if m.account_id != nil {
		fields = append(fields, composioaccount.FieldAccountID)
	}
	if m.toolkit != nil {
		fields = append(fields, composioaccount.FieldToolkit)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ComposioAccountMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ComposioAccountMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case composioaccount.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case composioaccount.FieldUpdatedAt:
	...
	case composioaccount.FieldToolkit:
		return m.OldToolkit(ctx)
	}
	return nil, fmt.Errorf("unknown ComposioAccount field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ComposioAccountMutation) SetField(name string, value ent.Value) error {
	switch name {
	case composioaccount.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	return fmt.Errorf("unknown ComposioAccount field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ComposioAccountMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ComposioAccountMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ComposioAccountMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown ComposioAccount numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ComposioAccountMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(composioaccount.FieldToolkit) {
		fields = append(fields, composioaccount.FieldToolkit)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *ComposioAccountMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *ComposioAccountMutation) ClearField(name string) error {
	switch name {
	case composioaccount.FieldToolkit:
		m.ClearToolkit()
		return nil
	}
	return fmt.Errorf("unknown ComposioAccount nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ComposioAccountMutation) ResetField(name string) error {
	switch name {
	case composioaccount.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *ComposioAccountMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.user != nil {
		edges = append(edges, composioaccount.EdgeUser)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ComposioAccountMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case composioaccount.EdgeUser:
		if id := m.user; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *ComposioAccountMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ComposioAccountMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ComposioAccountMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.cleareduser {
		edges = append(edges, composioaccount.EdgeUser)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *ComposioAccountMutation) EdgeCleared(name string) bool {
	switch name {
	case composioaccount.EdgeUser:
		return m.cleareduser
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *ComposioAccountMutation) ClearEdge(name string) error {
	switch name {
	case composioaccount.EdgeUser:
		m.ClearUser()
		return nil
	}
	return fmt.Errorf("unknown ComposioAccount unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ComposioAccountMutation) ResetEdge(name string) error {
	switch name {
	case composioaccount.EdgeUser:
		m.ResetUser()
		return nil
	}
	return fmt.Errorf("unknown ComposioAccount edge %s", name)
}
...
type UserMutation struct {
	...
	composio_accounts                      map[uuid.UUID]struct{}
	removedcomposio_accounts               map[uuid.UUID]struct{}
	clearedcomposio_accounts               bool
...
func (m *UserMutation) AddComposioAccountIDs(ids ...uuid.UUID) {
	if m.composio_accounts == nil {
		m.composio_accounts = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		m.composio_accounts[ids[i]] = struct{}{}
	}
}

// ClearComposioAccounts clears the "composio_accounts" edge to the ComposioAccount entity.
func (m *UserMutation) ClearComposioAccounts() {
	m.clearedcomposio_accounts = true
}

// ComposioAccountsCleared reports if the "composio_accounts" edge to the ComposioAccount entity was cleared.
func (m *UserMutation) ComposioAccountsCleared() bool {
	return m.clearedcomposio_accounts
}

// RemoveComposioAccountIDs removes the "composio_accounts" edge to the ComposioAccount entity by IDs.
func (m *UserMutation) RemoveComposioAccountIDs(ids ...uuid.UUID) {
	if m.removedcomposio_accounts == nil {
		m.removedcomposio_accounts = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		delete(m.composio_accounts, ids[i])
		m.removedcomposio_accounts[ids[i]] = struct{}{}
	}
}

// RemovedComposioAccounts returns the removed IDs of the "composio_accounts" edge to the ComposioAccount entity.
func (m *UserMutation) RemovedComposioAccountsIDs() (ids []uuid.UUID) {
	for id := range m.removedcomposio_accounts {
		ids = append(ids, id)
	}
	return
}

// ComposioAccountsIDs returns the "composio_accounts" edge IDs in the mutation.
func (m *UserMutation) ComposioAccountsIDs() (ids []uuid.UUID) {
	for id := range m.composio_accounts {
		ids = append(ids, id)
	}
	return
}

// ResetComposioAccounts resets all changes to the "composio_accounts" edge.
func (m *UserMutation) ResetComposioAccounts() {
	m.composio_accounts = nil
	m.clearedcomposio_accounts = false
	m.removedcomposio_accounts = nil
}
...
func (m *UserMutation) AddedEdges() []string {
	...
	if m.composio_accounts != nil {
		edges = append(edges, user.EdgeComposioAccounts)
	}
	if m.background_tasks != nil {
...
func (m *UserMutation) AddedIDs(name string) []ent.Value {
	...
	case user.EdgeMcpConnections:
		...
		return ids
	case user.EdgeComposioAccounts:
		ids := make([]ent.Value, 0, len(m.composio_accounts))
		for id := range m.composio_accounts {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []ent.Value {
	...
	case user.EdgeMcpConnections:
		...
		return ids
	case user.EdgeComposioAccounts:
		ids := make([]ent.Value, 0, len(m.removedcomposio_accounts))
		for id := range m.removedcomposio_accounts {
			ids = append(ids, id)
		}
		return ids
