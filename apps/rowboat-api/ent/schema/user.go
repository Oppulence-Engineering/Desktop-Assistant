...
func (User) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.To("voice_api_keys", VoiceAPIKey.Type).Annotations(entproto.Skip(), entgql.Skip()),
		edge.To("voice_sync_items", VoiceSyncItem.Type).Annotations(entproto.Skip(), entgql.Skip()),
		edge.To("capture_artifacts", CaptureArtifact.Type).Annotations(entproto.Skip(), entgql.Skip()),
		...
		edge.To("connector_audit_events", ConnectorAuditEvent.Type).Annotations(entproto.Skip(), entgql.Skip()),
		...
		edge.To("revenue_trust_events", RevenueTrustEvent.Type).Annotations(entproto.Skip()),
		edge.To("relationship_identity_candidates", RelationshipIdentityCandidate.Type).Annotations(entproto.Skip()),
		edge.To("relationship_lineage_events", RelationshipLineageEvent.Type).Annotations(entproto.Skip()),
		edge.To("relationship_identity_decisions", RelationshipIdentityDecision.Type).Annotations(entproto.Skip()),
		edge.To("relationship_review_acknowledgements", RelationshipReviewAcknowledgement.Type).Annotations(entproto.Skip()),
		edge.To("relationship_attention_items", RelationshipAttentionItem.Type).Annotations(entproto.Skip()),
