...
func addRevenueSchemas(schemas obj) {
	...
	schemas["CommitmentEvent"] = objectSchema("One immutable event in a commitment transition stream.", obj{
		...
		"kind":                       stringEnum("Transition kind.", "accepted", "proposed", "internally_confirmed", "offered", "accepted", "disputed", "blocked", "unblocked", "corrected", "due_date_changed", "renegotiated", "fulfilled", "cancelled", "superseded"),
