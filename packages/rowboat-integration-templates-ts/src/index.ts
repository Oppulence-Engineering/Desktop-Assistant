...
export const IntegrationTemplateBlockSchema = z.object({
  ...
  nativeTools: z.array(z.string().min(1)).default([]),
    ...
    blocks: [
      {
        ...
        category: "crm",
        requiredScopes: [],
        nativeTools: ["connector.read.hubspot_search"],
        trustTier: "read",
      ...
      },
      {
        ...
        category: "crm",
        requiredScopes: [],
        nativeTools: ["connector.write.hubspot_note", "connector.write.hubspot_task"],
        trustTier: "act",
